...
namespace LibGit2Sharp
{
    ...
    public class BlameHunkCollection : IEnumerable<BlameHunk>
    {
        ...
        internal unsafe BlameHunkCollection(Repository repo, RepositoryHandle repoHandle, string path, BlameOptions options)
        {
            ...
            rawopts.flags = GitBlameOptionFlags.GIT_BLAME_FIRST_PARENT| GitBlameOptionFlags.GIT_BLAME_TRACK_COPIES_ANY_COMMIT_COPIES| GitBlameOptionFlags.GIT_BLAME_TRACK_COPIES_SAME_FILE;
